...
function doIt() {
  ...
  if [[ $(uname -s) = Darwin ]]; then
    ...
    rm -rf ~/soft_pc/macos/fzf && xattr ~/soft_pc/macos/fzf-0.57.0-darwin_arm64.tar.gz &&
    ...
    rm -rf ~/soft_pc/linux/yazi-x86_64-unknown-linux-gnu/ && unzip ~/soft_pc/linux/yazi-x86_64-unknown-linux-gnu.zip -d ~/soft_pc/linux/ && rm -rf ~/soft_pc/linux/yazi-x86_64-unknown-linux-gnu.zip
  fi
